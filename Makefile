...
I386_LIBS = 
OPENGL_LIBS = 
DLLFLAGS =  -fno-PIC -fasynchronous-unwind-tables
LDDLLFLAGS = -fno-PIC -Wl,-z,notext -fasynchronous-unwind-tables
LDEXECFLAGS = 
...
WINEPRELOADER_LDFLAGS = -nostartfiles -nodefaultlibs -static -Wl,-Ttext=0x7d400000
DLLEXT = .so
LDD = /usr/bin/ldd
OTOOL = otool
READELF = readelf
SUBDIRS =  \
	...
	dlls/windows.storage \
	dlls/windows.storage/tests \
	...
	tools/wmc \
	tools/wrc
DISABLED_SUBDIRS =  dlls/capi2032 dlls/gphoto2.ds dlls/protontts dlls/sane.ds dlls/winealsa.drv dlls/wineandroid.drv dlls/winecoreaudio.drv dlls/winegstreamer dlls/winemac.drv dlls/wineoss.drv dlls/winepulse.drv dlls/wineusb.sys dlls/winewayland.drv dlls/winscard dlls/wpcap po
CONFIGURE_TARGETS =  wine TAGS tags autom4te.cache compile_commands.json config.log config.status include/config.h include/stamp-h
CARBON_LIBS = 
COREFOUNDATION_LIBS = 
...
DRM_LIBS = -ldrm 
DRMAMDGPU_CFLAGS = -I/usr/include/libdrm 
DRMAMDGPU_LIBS = -ldrm_amdgpu 
GMP_CFLAGS = 
GMP_LIBS = -lgmp
SANE_CFLAGS = 
SANE_LIBS = 
...
PIPER_CFLAGS = 
PIPER_LIBS = 
MSVCRTFLAGS = -D_WIN32 -fno-builtin -fshort-wchar -Wno-format -fno-omit-frame-pointer
DELAYLOADFLAG = 
